...
# -*- coding: utf-8 -*-
#
# Blowb documentation build configuration file, created by
...
html_use_opensearch = 'http://docs.blowb.org'
...
latex_appendices = ['appendices/update-dnsmasq',
...
# Documents to append as an appendix to all manuals.
texinfo_appendices = ['appendices/update-dnsmasq',
                      'appendices/list-of-nginx-config',
                      'appendices/bug-and-contribution',
                      'appendices/source',
                      'appendices/references',
...
epub_title = 'Blowb'
epub_author = 'Hong Xu <hong@topbug.net>'
epub_publisher = 'Hong Xu <hong@topbug.net>'
epub_copyright = '2015, Hong Xu <hong@topbug.net>'
